...
methods
    ...
    function obj = STB_UI(mon_num, file_path)
        ...
        obj.movie_3D_avg_vars = ["u","v","w","|U|","ω_x","ω_y","ω_z","|ω|",...
                    ...
                    "du/dx","du/dy","du/dz","dv/dx","dv/dy","dv/dz","dw/dx","dw/dy","dw/dz", "div"];
        ...
        "dwdx_phase_avg","dwdy_phase_avg","dwdz_phase_avg", "div"];
    ...
    function update_plot(obj, plot_panel)
        ...
        if ismember(plot_idx, [1, 2, 4, 8])
            ...
            if obj.extrapolate_bool
                ...
                vars = {"L","U","num_bins","cycle_freq","z_B","y_B",var_name};
            else
