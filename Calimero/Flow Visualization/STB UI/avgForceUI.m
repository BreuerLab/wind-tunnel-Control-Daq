    ...
    methods
        ...
        function obj = avgForceUI(mon_num, data_path)
            ...
            obj.box_labels = ["lift vortX", "lift vortY", "lift vel diff", "lift vel", "drag_vort", "drag_vel",...
                            ...
                            "KE wake", "power wake", "KE Full", "enstrophy", "helicity", "avg U", "pitot U", "# bins"];
            obj.var_names = ["lift.vortX", "lift.vortY", "lift.vel", "lift_vel", "drag.tot", "drag_vel",...
                ...
                "KE_diff", "power", "KE_tot", "enst", "hel_phase_avg", "u_avg", "U_act", "num_bins"];
            ...
            obj.y_labels = ["Lift (N)", "Lift (N)", "Lift (N)", "Lift (N)", "Drag (N)", "Drag (N)",...
                ...
                "KE", "power", "KE", "Enstrophy", "Helicity", "Freestream Speed", "Freestream Speed", "count"];
            obj.PIV_sub = false;
            obj.force_sub = false;
            obj.filt_num = 3;
