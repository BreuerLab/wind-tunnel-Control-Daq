function [norm_frame_pos, bin_ind_arr, num_bins] = frame_to_bin(PIV_case_name, num_images)
...
enc_pos_norm = enc_pos / ticksPerRev;

disp("Using " + num_bins + " bins")
% num_bins = 25; % for 4 Hz
bins = linspace(0,1,num_bins+1);
bin_ind_arr = discretize(enc_pos_norm, bins);
