...
methods
    function obj = compareAoAUI(mon_num, data_path)
        ...
        for i = 1:2
            if i == 1
                path = obj.data_path + "/plot data/" + "Flapperoo/";
...
methods (Access = private)
    function update_plot(obj, plot_panel)
        ...
        struct_matches = get_file_matches(obj.selection, obj.norm, obj.shift, obj.drift, obj.sub, obj.Flapperoo, obj.Calimero);
        ...
        if (obj.index == 0)
            ...
            for i = 1:length(obj.selection)
                ...
                cur_bird = getBirdFromName(flapper_name, obj.Flapperoo, obj.Calimero);
