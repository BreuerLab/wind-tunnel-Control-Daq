...
data_path = uigetdir(".", "Select the folder containing 'raw data' and 'processed data'") + "\";
...
path_parts = split(extractBefore(data_path, "m.s"), "\");
root_path = strjoin(path_parts(1:end-1), "\");

% Make plot data folder
dirPath = root_path + "\plot data\Calimero\";
...
processed_data_path = [processed_data_path data_path + "/processed data/"];
offsets_path = [offsets_path data_path + "/raw data/offsets data/"];
