function colors = getColors(num_types, num_speeds, num_freq)
    sorted_nums = sort([num_types, num_speeds, num_freq]); % ascending
    if (sorted_nums(1) > 1)
    ...
    elseif (sorted_nums(2) > 2)
        disp("Ah, but I only have 2 color shade groups")
        colors = ["#3BD9A5","#D9CD3B","#9E312C";...
                  "#333268","#2C3331","#4BEA59";...
                  "#845A4F","#84804F","#673BD9";...
                  "#D95A3B","#645099","#4F8473"];
    ...
    if (sorted_nums(3) == 8)
       ...
       colors(:,3) = ["#e5f5e0";"#c7e9c0";"#a1d99b";"#74c476";...
                    "#41ab5d";"#238b45";"#006d2c";"#00441b"]; 
        end
    elseif (sorted_nums(3) == 7)
        if (i == 1)
        colors(:,1) = ["#fee6ce";"#fdd0a2";"#fdae6b";"#fd8d3c";...
    ...
    elseif (sorted_nums(3) == 6)
        ...
        colors(:,3) = ["#c7e9c0";"#a1d99b";"#74c476";...
                       "#41ab5d";"#238b45";"#005a32"];  
        end
    elseif (sorted_nums(3) == 5)
        if (i == 1)
        colors(:,1) = ["#fdd0a2";"#fdae6b";"#fd8d3c";...
                       "#e6550d";"#a63603"];
        elseif (i == 2)
    ...
    elseif (sorted_nums(3) == 4)
        ...
        colors(:,3) = ["#bae4b3";"#74c476";"#31a354";...
                       "#006d2c"];    
        end
    elseif (sorted_nums(3) == 3)
        if (i == 1)
        colors(:,1) = ["#fdbe85";"#fd8d3c";"#d94701"];
        elseif (i == 2)
        colors(:,2) = ["#cbc9e2";"#9e9ac8";"#6a51a3"];
        else
        colors(:,3) = ["#bae4b3";"#74c476";"#238b45"];    
        end
    elseif (sorted_nums(3) == 2)
        if (i == 1)
        colors(:,1) = ["#fdae6b";"#e6550d"];
        elseif (i == 2)
        colors(:,2) = ["#bcbddc";"#756bb1"];
        else
        colors(:,3) = ["#a1d99b";"#31a354"];    
        end
    elseif (sorted_nums(3) == 1)
        if (i == 1)
        colors(:,1) = ["#e6550d"];
        elseif (i == 2)
        colors(:,2) = ["#756bb1"];
