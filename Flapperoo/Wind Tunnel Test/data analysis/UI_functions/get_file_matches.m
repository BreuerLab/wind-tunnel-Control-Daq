function struct_matches = get_file_matches(selection_list, norm_bool, shift_bool, drift_bool, sub_bool, Flapperoo, MetaBird)
    struct_matches = [];
    ...
    for i = 1:length(selection_list)
        ...
        % different form
        if (contains(dir_name, "Hz") || contains(dir_name, "St"))
