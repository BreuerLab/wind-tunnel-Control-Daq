function aero_force = get_model(flapper, path, AoA_list, freq, speed, lift_slope, pitch_slope, AR, amp)
    ...
    for i = 1:length(AoA_list)
        ...
        [C_L, C_D, C_N, C_M] = get_aero(ang_disp, eff_AoA, u_rel, speed, wing_length, lift_slope, pitch_slope, AR, AoA);
