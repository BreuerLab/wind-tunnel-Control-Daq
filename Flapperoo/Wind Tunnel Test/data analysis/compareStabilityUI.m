...
methods
    ...
    function dynamic_plotting(obj)
        ...
        d4.Items = ["Stability Slope", "Equilibrium Position", "COM", "Static Margin", "Neutral Position", "Moment at NP", "Equilibrium"];
        ...
        function plot_type_change(src, ~, plot_panel)
            options = ["Stability Slope", "Equilibrium Position", "COM", "Static Margin", "Neutral Position", "Moment at NP", "Equilibrium"];
...
methods (Access = private)
    function update_plot(obj, plot_panel)
        ...
        if (obj.plot_type == 1 || obj.plot_type == 2 || obj.plot_type == 5 || obj.plot_type == 6)
            if (obj.st)
            ...
            if (obj.plot_type == 3 || obj.plot_type == 7)
        ...
        elseif (obj.plot_type == 6)
            y_label = "Moment at Neutral Position";
        elseif (obj.plot_type == 7)
            y_label = "Equilibrium Angle (deg)";
        end
        ...
        if (obj.plot_type == 3 || obj.plot_type == 4 || obj.plot_type == 7)
            % sequential colors
        ...
        for i = 1:length(obj.selection)
            ...
            if (obj.plot_type == 3 || obj.plot_type == 4 || obj.plot_type == 5 || obj.plot_type == 6 || obj.plot_type == 7)
            ...
            for k = 1:length(wing_freqs)
                ...
                if (obj.plot_type == 5 || obj.plot_type == 6)
