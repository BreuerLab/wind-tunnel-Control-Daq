function model_plot(path, wind_speed, wing_freq, AoA, ...
    ...
    [time, ang_disp, ang_vel, ang_acc] = get_kinematics(path, wing_freq, -1);
    ...
    if (sub_bool)
        ...
        [sub_time, sub_ang_disp, sub_ang_vel, sub_ang_acc] = get_kinematics(path, sub_wing_freq, -1);
