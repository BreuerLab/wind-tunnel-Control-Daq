...
if (nondimensional)
    ...
    plot_forces(time_data, dimensionless(results_lab, norm_factors), case_name, subtitle, axes_labels, 5);
    
    subtitle = "Trimmed, Rotated, Filtered";
    axes_labels = [x_label, y_label_F, y_label_M];
    plot_forces(time_data, dimensionless(filtered_data, norm_factors), case_name, subtitle, axes_labels, 5);
