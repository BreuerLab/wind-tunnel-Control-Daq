...
[wingbeat_forces, frames, wingbeat_avg_forces, wingbeat_std_forces, ...
    wingbeat_rmse_forces, wingbeat_max_forces, wingbeat_min_forces] = wingbeat_transformation(num_wingbeats, filtered_data);

save(path + '..\processed data\' + filename, 'wingbeats', 'wingbeat_forces', ...
