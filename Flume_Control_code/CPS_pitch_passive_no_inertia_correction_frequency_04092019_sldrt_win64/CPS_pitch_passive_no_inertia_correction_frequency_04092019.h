/*
 * CPS_pitch_passive_no_inertia_correction_frequency_04092019.h
 *
...
#ifndef RTW_HEADER_CPS_pitch_passive_no_inertia_correction_frequency_04092019_h_
#define RTW_HEADER_CPS_pitch_passive_no_inertia_correction_frequency_04092019_h_
#include <string.h>
#ifndef CPS_pitch_passive_no_inertia_correction_frequency_04092019_COMMON_INCLUDES_
# define CPS_pitch_passive_no_inertia_correction_frequency_04092019_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* CPS_pitch_passive_no_inertia_correction_frequency_04092019_COMMON_INCLUDES_ */

#include "CPS_pitch_passive_no_inertia_correction_frequency_04092019_types.h"
...
#define CPS_pitch_passive_no_inertia_correction_frequency_04092019_rtModel RT_MODEL_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T

/* Block signals (auto storage) */
typedef struct {
  real_T conversionmatrix[6];          /* '<Root>/conversion  matrix' */
  real_T inverseInertia;               /* '<Root>/inverse  Inertia' */
  real_T Integrator1;                  /* '<Root>/Integrator1' */
  real_T Integrator1_e;                /* '<Root>/Integrator 1' */
  real_T TmpSignalConversionAtForcesInport1[3];
  real_T pitchmeasuredrad;             /* '<Root>/conversion2' */
  real_T targetpitchoutrad;            /* '<Root>/target pitch out(rad)' */
...
typedef struct {
  ...
  real_T Integrator1_DSTATE_a;         /* '<Root>/Integrator 1' */
  ...
  struct {
    void *LoggedData;
  } pos_pitch_PWORK;                   /* '<Root>/pos_pitch' */

  struct {
    void *LoggedData;
  } torque_PWORK;                      /* '<Root>/torque' */

  struct {
    void *LoggedData;
  } velocity_PWORK;                    /* '<Root>/velocity' */

  uint8_T Integrator1_SYSTEM_ENABLE;   /* '<Root>/Integrator1' */
  uint8_T Integrator1_SYSTEM_ENABLE_h; /* '<Root>/Integrator 1' */
} DW_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T;

/* Backward compatible GRT Identifiers */
#define rtB                            CPS_pitch_passive_no_inertia_correction_frequency_04092019_B
#define BlockIO                        B_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T
#define rtP                            CPS_pitch_passive_no_inertia_correction_frequency_04092019_P
#define Parameters                     P_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T
#define rtDWork                        CPS_pitch_passive_no_inertia_correction_frequency_04092019_DW
#define D_Work                         DW_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T

/* Parameters (auto storage) */
struct P_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T_ {
  real_T Bv;                           /* Variable: Bv
                                        * Referenced by: '<Root>/virtual damping1'
                                        */
  real_T Ip;                           /* Variable: Ip
  ...
  real_T AnalogOutput1_YieldWhenWaiting;/* Mask Parameter: AnalogOutput1_YieldWhenWaiting
                                         * Referenced by: '<Root>/Analog Output1'
                                         */
  int32_T AnalogInput1_Channels[8];    /* Mask Parameter: AnalogInput1_Channels
                                        * Referenced by: '<Root>/Analog Input1'
                                        */
  ...
  real_T torad_Gain;                   /* Expression: 1/180*pi
                                        ...
                                        */
  real_T offsetdeg_Value;              /* Expression: 0
                                        * Referenced by: '<Root>/offset(deg)'
                                        */
  real_T forcebias_Bias[6];            /* Expression: -tare.signals.values(end,:)
  ...
  real_T Constant2_Value;              /* Expression: 0
                                        ...
                                        */
  real_T angleoutdeg_Gain;             /* Expression: -5.*10/30000*12800/360*1.00*180/pi
                                        * Referenced by: '<Root>/angle out deg'
                                        */
  real_T positionoutVoltage_Gain;      /* Expression: -1/0.03
                                        * Referenced by: '<Root>/position out  (Voltage)'
                                        */
  real_T conversion2_Gain;             /* Expression: -1/3.83
                                        * Referenced by: '<Root>/conversion2'
                                        */
  real_T targetpitchoutrad_Gain;       /* Expression: 1
                                        * Referenced by: '<Root>/target pitch out(rad)'
                                        */
  real_T virtualmass1_Gain;            /* Expression: 0
  ...
  real_T conversion1_Gain;             /* Expression: 0.4
                                        ...
                                        */
  uint8_T zero1_CurrentSetting;        /* Computed Parameter: zero1_CurrentSetting
                                        * Referenced by: '<Root>/zero1'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T {
  const char_T *path;
...
extern P_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T
  CPS_pitch_passive_no_inertia_correction_frequency_04092019_P;

/* Block signals (auto storage) */
extern B_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T
  CPS_pitch_passive_no_inertia_correction_frequency_04092019_B;

/* Block states (auto storage) */
extern DW_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T
  CPS_pitch_passive_no_inertia_correction_frequency_04092019_DW;

/* Model entry point functions */
extern void
  CPS_pitch_passive_no_inertia_correction_frequency_04092019_initialize(void);
extern void CPS_pitch_passive_no_inertia_correction_frequency_04092019_output
  (void);
extern void CPS_pitch_passive_no_inertia_correction_frequency_04092019_update
  (void);
extern void CPS_pitch_passive_no_inertia_correction_frequency_04092019_terminate
  (void);

/*====================*
 * External functions *
 *====================*/
extern CPS_pitch_passive_no_inertia_correction_frequency_04092019_rtModel
...
extern RT_MODEL_CPS_pitch_passive_no_inertia_correction_frequency_04092019_T *
  const CPS_pitch_passive_no_inertia_correction_frequency_04092019_M;
 ...
 *
 * '<Root>' : 'CPS_pitch_passive_no_inertia_correction_frequency_04092019'
 */
#endif                                 /* RTW_HEADER_CPS_pitch_passive_no_inertia_correction_frequency_04092019_h_ */
