function out = CaptureVid_v1
%CAPTUREVID_V1 Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, CAPTUREVID_V1.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, CaptureVid_v1, at the MATLAB command prompt.
%   
%   The code file, CAPTUREVID_V1.M and its associated MAT-file, CAPTUREVID_V1.MAT (if
%   it exists) must be on your MATLAB path.
%   
%   Example: 
%       vidobj = CaptureVid_v1;
%   
...
try
    MATvar = load('C:\Users\ControlSystem\Documents\vertfoil\Control_code\CaptureVid_v1');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\ControlSystem\Documents\vertfoil\Control_code\CaptureVid_v1.mat.
if (MATLoaded)
