function foil = calc_single_foil_opt(param,number_of_cycles,dat,out,path_name, avg_vel)
...
%     M(:,1) = 2.2923; % 10 cm x 45 cm rect with enplates (6/8/2017)
    M(:,1) = 2.27; % 10 cm x 45 cm rect with enplates (6/8/2017)
    I(:,1) = 0.0029; % 10 cm x 45 cm rect with enplates (6/8/2017)
%     M = 0; %No Foil
%     I = 0;  %No Foil
%     M = 1.100; %kg carbon fiber ellipse
%     I = 0.0011120; %carbon fiber ellipse
%     I = 0.0011;
%     M(:,1) = 0; %3 inch x 5/16 inch rectangular aluminum (1/7/2016 -Michael)
%     I(1,1) = 0;  %3 inch x 5/16 inch rectangular aluminum  (1/7/2016 -Michael)
