...
% ch2.TerminalZ
global ch3
ch3=s.addCounterInputChannel('Dev2','ctr0','Position');
ch3.EncoderType='X4';
ch3.ZResetEnable=0;
...
ch3.ZResetValue = -795;
global ch4
ch4=s.addCounterInputChannel('dev2','ctr1','Position');
ch4.EncoderType='X4';
ch4.ZResetEnable=0;
...
% ch4.TerminalZ
global ch5
ch5=s.addCounterInputChannel('Dev2','ctr2','Position');
ch5.EncoderType='X4';
ch5.ZResetEnable=0;
...
ch5.ZResetValue = 338;
global ch6
ch6=s.addCounterInputChannel('Dev2','ctr3','Position');
ch6.EncoderType='X4';
ch6.ZResetEnable=0;
