function [ Pitch, Heave, t ] = prof_transition_rig3(param1, phase1,pitch_bias1,param2,phase2,pitch_bias2,rate)
...
[Pitch_initial, Heave_initial, t] = single_cycle_rig3(param1,phase1,pitch_bias1,rate);
...
[Pitch_final, Heave_final] = single_cycle_rig3(param2,phase2,pitch_bias2,rate);
