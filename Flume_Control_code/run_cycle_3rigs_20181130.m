...
% 
[p_prof2,h_prof2] = single_cycle_gromit([freq3, pitch3, heave3],phase12,0,s.Rate);%figure;plot(p_prof2),hold on,plot(h_prof2*100);
% -(last_out(2)+0.888888888888889)*360/5
...
[p_prof3,h_prof3] = single_cycle_wallace([freq2, pitch2, heave2,phi],phase13,0,s.Rate); %figure;plot(p_prof3),hold on,plot(h_prof3*100);
% -(last_out(2)+0.888888888888889)*360/5
