function [flume,out,dat,Prof2,Prof_out] = run_cycle_3rigs_opt(param, number_of_cycles)
...
param(3) = param(3) *chord;
param(7:8) = param(7:8)*chord;
param(11:12) = param(11:12)*chord;
...
[p_prof3,h_prof3] = single_cycle_wallace(param,phase13,0,s.Rate);
% -(last_out(2)+0.888888888888889)*360/5
[p_prof_trans3,h_prof_trans3] = prof_transition_rig2([freq2,last_pos(5:6)], phase13,0,param,phase13,0,s.Rate);
[p_prof_trans4,h_prof_trans4] = prof_transition_rig2(param,phase13,0,[freq2,0, 0,90],phase13,0,s.Rate);
rate = s.Rate;
...
%Wallace
flume.foil3 = calc_single_foil_opt(param,number_of_cycles,dat(:,[5,6,7:12,13:16]),out(:,[5,6,7:12,13:16]),path_name, avg_vel);
flume.data = dat;
flume.out = out;
