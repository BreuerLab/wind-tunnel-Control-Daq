function [flume,out,dat,Prof2,Prof_out] = run_cycle_3rigs(freq1,pitch1,heave1_per_chord,pitch3,heave3_per_chord,pitch2,heave2_per_chord, phase12,phase13, number_of_cycles,phi)
...
[flume.Vectrino(:,1),flume.Vectrino(:,2),flume.Vectrino(:,3),flume.Vectrino(:,4)] = vectrino_2_mat_test(T_start,Length);
