...
etime = datenum(T(2,:));
 ...
 cwd = 'C:\Users\ControlSystem\Documents\vertfoil\Experiments\Vectrino\MaxJune12th';
...
ftimes = datenum(num2str(tstart),'yyyymmddHHMMSS');
...
if isempty(t_ind)
    pause(2)
    fnames = dir(['C:\Users\ControlSystem\Documents\vertfoil\Experiments\Vectrino\MaxJune12th','*.vna']);
