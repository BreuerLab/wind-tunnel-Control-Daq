...
freq = [0.3:.2]; %[0.2:0.2:2]; %[0.2:0.1:1.0];     %[0.4,0.8]; %0.5;   %  [0.2,1,2];   %  0.5; % 1; %[0.5:0.1:1.0]; % % frequency [Hz]
...
%     Nframes = fps*(Ncycles/f + 5);  % add 5 seconds buffer
    ...
    SaveFolder = ['C:\Users\ControlSystem\Documents\vertfoil\Experiments\1foil\Membrane\Membrane_Heave\In_water\EmptyFrame_with_EndPlates_Heave\tesst\',Properties,'_cam_fs',num2str(fps)];
