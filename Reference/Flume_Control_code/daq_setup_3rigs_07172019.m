...
function daq_setup_3rigs_02072019
...
%% Inputs
global chins1 chins2 chins3 chins4
chins1=s.addAnalogInputChannel('dev2',[0 1 2 3 4 5],'Voltage');
chins2=s.addAnalogInputChannel('dev3',[6 7 8 9],'Voltage');
% chins3=s.addAnalogInputChannel('dev2',[16 17 18 19 20 21],'Voltage');
chins3=s.addAnalogInputChannel('dev3',[0 1 2 3 4 5],'Voltage');
% chins4 = s.addAnalogInputChannel('dev3',[2],'Voltage');
    
chins4=s.addDigitalChannel('dev2','Port0/line10','InputOnly'); % record the trigger signal
